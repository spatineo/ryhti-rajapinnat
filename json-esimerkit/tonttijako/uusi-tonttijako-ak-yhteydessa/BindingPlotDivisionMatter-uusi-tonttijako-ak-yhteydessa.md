...
Huomaa, että tiedoston sisältö ei ole täysin realistinen, ja ettei se validoidu oikein ilman ```permanentBindingPlotDivisionIdentifier```- ja ```filekey```-attribuutien arvoja.
...
```json
  {
    ...
    "permanentBindingPlotDivisionIdentifier": null,
          ...
          "plotDivisionPlots": [
            {
              ...
              "areaReservationRegulationUris": [
                "https://uri.rakennetunymparistontietojarjestelma.fi/planregulation/ece18b9-74d0-4067-a48e-b30577300e42"
              ],
              "volumeOfBuildingRegulationUris": [
                "https://uri.rakennetunymparistontietojarjestelma.fi/planregulation/8cfb5dbc-8ae9-4476-a57a-8f349f7bc3f3"
              ]
            },
            {
