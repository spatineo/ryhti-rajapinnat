# json-esimerkit/tonttijako/erillinen-sitova-tonttijako/BindingPlotDivisionMatter-erillinen-sitova-tonttijako

Seuraava JSON-tiedosto on generoitu suoraan YAML-tiedostosta [BindingPlotDivisionMatter-erillinen-sitova-tonttijako.yml](./BindingPlotDivisionMatter-erillinen-sitova-tonttijako.yml).
...
{
  "name": {
    "fin": "Esimerkki sitovan tonttijaon asiasta, joka on hyväksytty erillisellä päätöksellä"
  },
  "description": {
    "fin": "Tässä kuvataan miten kokonainen sitovan tonttijaon asia vaiheineen kuvataan JSON-muodossa"
  },
  "bindingPlotDivisionType": "http://uri.suomi.fi/codelist/rytj/sitovanTonttijaonLaji/code/02",
  "permanentBindingPlotDivisionIdentifier": "TJ-000090",
  ...
  "phases": [
    {
      ...
      "decision": {
        "bindingPlotDivisionMatterDecisionKey": "b82b5509-7515-46c1-8d5c-b95f924b1a4a",
        "decisionDate": "2025-12-01",
        "dateOfDecision": "2025-12-02",
        "dateOfValidity": "2026-01-01",
        "decisionDocuments": [
          {
            "attachmentDocumentKey": "61169f4c-e6b9-430c-8912-2440d25e7206",
            "documentIdentifier": "jokin-ahnro-12345",
            "name": {
              "fin": "Päätös erillisen sitovan tonttijaon hyväksymisestä"
            },
            "personalDataContent": "http://uri.suomi.fi/codelist/rytj/henkilotietosisalto/code/1",
            "categoryOfPublicity": "http://uri.suomi.fi/codelist/rytj/julkisuus/code/1",
            "accessibility": true,
            ...
            "fileKey": "3bf2097c-e5cc-45db-b117-752286ce75ea",
            "documentDate": "2025-12-01",
            "typeOfAttachment": "http://uri.suomi.fi/codelist/rytj/sitovanTonttijaonAsiakirjanLaji/code/11"
          }
        ],
        "decisionArticle": {
          "fin": "§1234"
        },
        "name": "http://uri.suomi.fi/codelist/rytj/AlueidenkayttopaatoksenNimi/code/0101",
        "typeOfDecisionMaker": null,
        "decisionMaker": {
          "bindingPlotDivisionOperatorKey": "40a5adc2-b754-477f-a062-834d4a0539c1",
          "organizationName": "Kunnan X kiinteistötoimitusosasto"
        }
