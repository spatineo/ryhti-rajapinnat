...
```json
{
  ...
  "planRegulationGroups": [
    ...
    },
    {
      ...
      "titleOfPlanRegulation": {
        "fin": "Määräys osoittaa, kuinka monta neliömetriä rakennusalalle sallitusta kerrostilavuudesta saadaan käyttää liiketilaa varten"
      },
      "planRegulations": [
        {
    ...
    },
    {
      ...
      "titleOfPlanRegulation": {
        "fin": "Määräys osoittaa, kuinka monta neliömetriä rakennusalalle sallitusta kerrostilavuudesta saadaan käyttää asumista varten"
      },
      "planRegulations": [
        {
