...
```json
{
  "permanentPlanIdentifier": "AK-000012",
  "planType": "http://uri.suomi.fi/codelist/rytj/RY_Kaavalaji/code/31",
  "name": {
    "fin": "Testikaava"
  },
  "timeOfInitiation": "2024-01-01",
  "description": {
    "fin": "Asemakaava Ryhti-testausta varten\nTäysin kuvitteellinen"
  },
  "producerPlanIdentifier": "AK-001",
  "caseIdentifiers": [
    "case-12345"
  ],
  "recordNumbers": [
  ...
  "responsibleParty": {
    ...
    "organizationName": "Kaupungin Y kaupunginvaltuusto"
  },
  "participationAndAssessmentScheme": {
    "participationAndAssessmentSchemeKey": "aaa4d563-fe5f-4023-9b1d-501e6f3fdedc",
    "attachmentDocuments": [
      {
        "attachmentDocumentKey": "53b3ab50-6142-470c-8e34-7e441b1b45ea",
        "documentIdentifier": "document-12345",
        "name": {
          "fin": "Kaavan Y osallistumis- ja arviointisuunnitelma"
        },
        ...
        "fileKey": "4f461c9d-6111-4ee4-ba8f-b70bf7d3fde9",
        "descriptors": [
          {
            "descriptorIdentifier": "http://www.yso.fi/onto/yso/p10728",
            "vocabulary": "YSO - Yleinen suomalainen ontologia",
            "descriptor": "osallistaminen"
          },
          {
            "descriptorIdentifier": "http://www.yso.fi/onto/yso/p8268",
            "vocabulary": "YSO - Yleinen suomalainen ontologia",
            "descriptor": "kaavoitus (maankäyttö)"
          }
        ],
  ...
  "sourceDatas": [
    {
      "planSourceDataKey": "5a78b796-7e4a-4c07-a31b-6ce2aeab0f64",
      "type": "http://uri.suomi.fi/codelist/rytj/RY_LahtotietoaineistonLaji/code/07",
      "name": {
        "fin": "Liikenneväyläsuunnitelma X"
      },
      "files": [
        {
          "attachmentDocumentKey": "23fc6f75-a251-410a-b433-bba81114a03b",
          "documentIdentifier": "document-456568",
          "name": {
            "fin": "Liikenneväyläsuunnitelma X.doc"
          },
          "personalDataContent": "http://uri.suomi.fi/codelist/rytj/henkilotietosisalto/code/1",
          "categoryOfPublicity": "http://uri.suomi.fi/codelist/rytj/julkisuus/code/1",
          "accessibility": true,
          ...
          "descriptors": [
            {
              "descriptorIdentifier": "http://www.yso.fi/onto/yso/p4675",
              "vocabulary": "YSO - Yleinen suomalainen ontologia",
              "descriptor": "liikenneverkot"
            },
            {
              "descriptorIdentifier": "http://www.yso.fi/onto/yso/p2498",
              "vocabulary": "YSO - Yleinen suomalainen ontologia",
              "descriptor": "liikenneväylät"
            }
          ],
          "documentDate": "2024-01-01",
          "typeOfAttachment": "http://uri.suomi.fi/codelist/rytj/RY_AsiakirjanLaji_YKAK/code/20"
        }
      ]
    }
  ],
  "planMatterPhases": [
    {
      "planMatterPhaseKey": "9e7206af-ad1e-4f21-8e48-a6dd15b0ef41",
      "lifeCycleStatus": "http://uri.suomi.fi/codelist/rytj/kaavaelinkaari/code/06",
      "geographicalArea": {
        "srid": "3880",
        "geometry": {
          "type": "Polygon",
      ...
      "planDecision": {
        "planDecisionKey": "03ccaed0-e882-4fbd-b430-ef9f1d8c687b",
        "name": "http://uri.suomi.fi/codelist/rytj/kaavpaatnimi/code/11A",
        "dateOfDecision": "2024-01-01",
        ...
        "decisionIdentifier": "paatos-123345",
        "plans": [
          {
            ...
            "planReport": {
              "planReportKey": "d69e815e-2a43-4c5d-8feb-3323b39f1b08",
              "attachmentDocuments": [
                {
                  "attachmentDocumentKey": "4c517b1f-3acd-4450-bfe8-73cfc0a8e293",
                  "documentIdentifier": "docuemnt-6263855+0",
                  "name": {
                    "fin": "Kaavaselostus X"
                  },
                  "personalDataContent": "http://uri.suomi.fi/codelist/rytj/henkilotietosisalto/code/1",
                  ...
                  "fileKey": "e1e28122-85b4-43ff-9eb7-51b134458bd7",
                  "documentDate": "2024-01-01",
            ...
            "planMaps": [
              {
                "planMapKey": "0ff285ee-2881-4985-b4f2-324ca1be2af0",
                "name": {
                  "fin": "Kaavakartta X"
                },
                "fileKey": "d12551b2-b287-477c-a0dd-5e8d3f13ee53",
                "coordinateSystem": "3880"
              }
            ]
          }
        ],
        "decisionMakers": [
          {
            "planOperatorKey": "083dac68-1780-4c49-84aa-2e9ea2e10021",
            "organizationName": "Kaupungin X kaupunginvaltuusto"
          }
        ]
      }
    }
